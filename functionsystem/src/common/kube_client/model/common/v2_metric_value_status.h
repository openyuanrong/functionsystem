...
#ifndef FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2METRIC_VALUE_STATUS_H
#define FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2METRIC_VALUE_STATUS_H
...
const std::string MODE_NAME_V2_METRIC_VALUE_STATUS = "V2MetricValueStatus";
class V2MetricValueStatus : public ModelBase {
public:
    V2MetricValueStatus();
    ~V2MetricValueStatus() override;
...
#endif /* FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2METRIC_VALUE_STATUS_H */
