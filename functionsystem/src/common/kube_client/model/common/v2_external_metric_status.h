...
#ifndef FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_STATUS_H
#define FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_STATUS_H
...
const std::string MODE_NAME_V2_EXTERNAL_METRIC_STATUS = "V2ExternalMetricStatus";
class V2ExternalMetricStatus : public ModelBase {
public:
    V2ExternalMetricStatus() noexcept;
    ~V2ExternalMetricStatus() override;
...
#endif /* FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_STATUS_H */
