...
#ifndef FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_SOURCE_H
#define FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_SOURCE_H
...
const std::string MODE_NAME_V2_EXTERNAL_METRIC_SOURCE = "V2ExternalMetricSource";
class V2ExternalMetricSource : public ModelBase {
public:
    V2ExternalMetricSource() noexcept;
    ~V2ExternalMetricSource() override;
...
#endif /* FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V2EXTERNAL_METRICS_SOURCE_H */
