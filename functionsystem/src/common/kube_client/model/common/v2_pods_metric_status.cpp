...
REGISTER_MODEL_OBJECT(V2PodsMetricStatus);

V2PodsMetricStatus::V2PodsMetricStatus() noexcept : m_currentIsSet(false),
    m_metricIsSet(false)
{}
...
nlohmann::json V2PodsMetricStatus::ToJson() const
{
...
bool V2PodsMetricStatus::FromJson(const nlohmann::json& val)
{
    bool ok = true;
...
std::shared_ptr<V2MetricValueStatus> V2PodsMetricStatus::GetCurrent() const
{
    return m_current;
}

void V2PodsMetricStatus::SetCurrent(const std::shared_ptr<V2MetricValueStatus>& value)
{
    m_current = value;
    m_currentIsSet = true;
}

bool V2PodsMetricStatus::CurrentIsSet() const
{
    return m_currentIsSet;
}

void V2PodsMetricStatus::UnsetCurrent()
{
    m_currentIsSet = false;
}
std::shared_ptr<V2MetricIdentifier> V2PodsMetricStatus::GetMetric() const
{
    return m_metric;
}

void V2PodsMetricStatus::SetMetric(const std::shared_ptr<V2MetricIdentifier>& value)
{
    m_metric = value;
    m_metricIsSet = true;
}

bool V2PodsMetricStatus::MetricIsSet() const
{
    return m_metricIsSet;
}

void V2PodsMetricStatus::UnsetMetric()
{
    m_metricIsSet = false;
}
}
