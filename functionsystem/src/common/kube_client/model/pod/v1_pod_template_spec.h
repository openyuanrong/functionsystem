...
#ifndef FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V1POD_TEMPLATE_SPEC_H
#define FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V1POD_TEMPLATE_SPEC_H
...
const std::string MODE_NAME_V1_POD_TEMPLATE_SPEC = "V1PodTemplateSpec";

class V1PodTemplateSpec : public ModelBase {
public:
    V1PodTemplateSpec();
    ~V1PodTemplateSpec() override;
...
#endif /* FUNCTIONSYSTEM_KUBE_CLIENT_MODEL_V1POD_TEMPLATE_SPEC_H */
