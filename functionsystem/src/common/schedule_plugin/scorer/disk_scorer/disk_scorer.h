...
#ifndef FUNCTIONSYSTEM_DISK_SCORER_H
#define FUNCTIONSYSTEM_DISK_SCORER_H
...
class DiskScorer : public schedule_framework::ScorePlugin {
public:
    DiskScorer() = default;
    ~DiskScorer() override = default;
...
#endif // FUNCTIONSYSTEM_DISK_SCORER_H
