...
#ifndef FUNCTIONSYSTEM_DISK_FILTER_H
#define FUNCTIONSYSTEM_DISK_FILTER_H
...
class DiskFilter : public schedule_framework::FilterPlugin {
public:
    DiskFilter() = default;

    ~DiskFilter() override = default;
...
#endif // FUNCTIONSYSTEM_DISK_FILTER_H
